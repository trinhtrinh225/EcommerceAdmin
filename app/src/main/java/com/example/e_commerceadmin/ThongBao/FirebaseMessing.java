...
public class FirebaseMessing extends FirebaseMessagingService {
    ...
    private void sendNormalNotification(RemoteMessage remoteMessage) {
        ...
        Intent intent = new Intent(this, PhanHoiKH.class);
        ...
        NotificationManager notificationManager = (NotificationManager)getSystemService(ContextWrapper.NOTIFICATION_SERVICE);
        int j = 0;
        if(i > 0) {
            j = i;
        }
